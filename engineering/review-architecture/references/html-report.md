...
Each candidate card names the modules involved, the current friction, the proposed deepening, leverage and locality payoff, how tests would improve, a before / after visual, and recommendation strength. End with a Top recommendation explaining why it merits the user's next decision, without assuming the next Skill.
