...
4. Fix findings through the owning ticket workflow, not during review. If any code, graph, or authority changed, prepare a new snapshot and recheck affected verification and review before accepting it.
