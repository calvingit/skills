    ...
    *,
    ...
    for ticket in tickets:
        ...
        if active_ticket:
            ...
            referenced_design_decisions = authority.get("referenced_design_decisions", set())
            ...
            if ticket["referenced_design_decisions"] and not has_hld:
            ...
            for decision in ticket["referenced_design_decisions"]:
                if decision not in referenced_design_decisions:
            ...
            if not ticket["covers"]["requirements"] and not ticket["covers"]["spec_acceptance"] and not ticket["referenced_design_decisions"]:
    ...
    coverage = {
        ...
        "referenced_design_decisions": sorted(authority.get("referenced_design_decisions", set()) - {value for ticket in active for value in ticket["referenced_design_decisions"]}),
    }
...
def graph_projection(
    ...
    return {
        ...
        else {"requirements": [], "spec_acceptance": [], "referenced_design_decisions": []},
