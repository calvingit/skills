...
Inspect unnecessary concepts, duplicated rules or state, obsolete paths, coupling, and maintenance burdens without a current responsibility within the agreed project scope.

When available, use the review mode of `simplify` for judgement. Do not start a redesign, interview, or implementation workflow. In a standalone installation, apply the local evidence and coverage rubrics; principles are investigation aids, not independent proof of a defect.
