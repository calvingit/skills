...
| [`explain-that`](./global/explain-that/SKILL.md) | 用简单语言、必要背景和具体例子重新解释未理解的回复内容。 |
...
| [`improve-agents-md`](./global/improve-agents-md/SKILL.md) | 创建或优化简洁、准确、可验证且适用于多种 Coding Agent 的 `AGENTS.md`。 |
...
| [`show-me`](./global/show-me/SKILL.md) | 使用最小必要的图示、代码结构或 HTML 帮助理解当前话题。 |
